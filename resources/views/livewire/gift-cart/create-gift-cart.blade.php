        ...
        <form x-ref="form_create" class="mt-3" wire:submit.prevent="save">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-3">
                    <x-jet-label class="block">Precio</x-jet-label>
                    <x-jet-input class="w-full mt-2" type="number" wire:model.defer="gift_card.price" />
                    @error('gift_card.price')<span class="error error-input">{{ $message }}</span>@enderror
                </div>

                <div class="col-span-3">
                    <x-jet-label class="block">Stock</x-jet-label>
                    <x-jet-input class="w-full mt-2" type="number" wire:model.defer="gift_card.stock" />
                    @error('gift_card.price')<span class="error error-input">{{ $message }}</span>@enderror
                </div>
                <div class="col-span-3">
                ...
                <div class="col-span-6">
                    <x-jet-label class="block">Imagen Principal</x-jet-label>
                    <div class="mt-2">

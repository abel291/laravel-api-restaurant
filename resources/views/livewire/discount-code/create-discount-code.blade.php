        ...
        <form x-ref="form_create" class="mt-3" wire:submit.prevent="save">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-6">
                    <x-jet-label class="block">Nombre</x-jet-label>
                    <x-jet-input class="w-full mt-2" type="text" wire:model.defer="discount_code.name" />
                    @error('discount_code.name')<span class="error error-input">{{ $message }}</span>@enderror
                </div>
                <div class="col-span-8">
                    <x-jet-label class="block">Pequeña Descripcion</x-jet-label>
                    <x-jet-input class="w-full mt-2" type="text" wire:model.defer="discount_code.description" />
                ...
                <div class="col-span-3">
                    <x-jet-label class="block">Codigo</x-jet-label>
                    <x-jet-input class="w-full mt-2 uppercase" type="text" wire:model.defer="discount_code.code" />
                ...
                <div class="col-span-3">
                    <x-jet-label class="block">Valor</x-jet-label>
                    <x-jet-input class="w-full mt-2" type="number" min="0" wire:model.defer="discount_code.value" />
                    @error('discount_code.value')<span class="error error-input">{{ $message }}</span>@enderror
                </div>

                <div class="col-span-3">
                    <x-jet-label class="block">Stock</x-jet-label>
                    <x-jet-input class="w-full mt-2" type="number" min="0" wire:model.defer="discount_code.stock" />
                    @error('discount_code.stock')<span class="error error-input">{{ $message }}</span>@enderror
                </div>

                <div class="col-span-3">
                    <x-jet-label class="block">Activo</x-jet-label>
                    <div>

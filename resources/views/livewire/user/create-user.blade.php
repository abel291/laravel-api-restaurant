            ...
            <div  class="bg-white shadow overflow-hidden sm:rounded-lg p-5">
                ...
                <div wire:loading.class="invisible" wire:target="create, edit">
                    ...
                    <form x-ref="form_create" class="mt-3" wire:submit.prevent="save">
                        <div class="divide-y divide-gray-100">
                            <div class="flex items-center py-4 ">
                                ...
                                <div class=" w-4/12">
                                    <x-jet-input type="text" wire:model.defer="user.name">
                                    </x-jet-input>
                                    @error('user.name')
                            ...
                            <div class="flex items-center py-4 ">
                                ...
                                <div class=" w-4/12">
                                    <x-jet-input type="email" wire:model.defer="user.email">
                                    </x-jet-input>
                                    @error('user.email')
                                        <span class="error error-input">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="flex items-center py-4 ">
                                ...
                                <div class=" w-4/12">
                                    <x-jet-input type="text" wire:model.defer="user.phone">
                                    </x-jet-input>
                                    @error('user.phone')
                                        <span class="error error-input">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="flex items-center py-4 ">
                                ...
                                <div class=" w-4/12">
                                    <div class="flex items-center">
                                        <div>
                                            <span>SI</span>
                                            <x-jet-input type="radio" name="active" value="1"
                                                wire:model.defer="user.active">
                                            </x-jet-input>
                                        </div>
                                        <div class="ml-3">
                                            <span>NO</span>
                                            <x-jet-input type="radio" name="active" value="0"
                                                wire:model.defer="user.active">
                                            </x-jet-input>
                                        </div>
                                    </div>
                            ...
                            <div class="flex items-center py-4 ">
                                ...
                                <div class=" w-4/12">
                                    <x-jet-input type="password" wire:model.defer="password">
                                    </x-jet-input>
                                    @error('password')
                                        <span class="error error-input">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="flex items-center py-4 ">
                                <x-jet-label class="w-3/12">Confirmar Contraseña</x-jet-label>
                                <div class=" w-4/12">
                                    <x-jet-input type="password" wire:model.defer="password_confirmation">
                                    </x-jet-input>
                    ...
                    <div class="text-right py-3">
                        ...
                        <x-jet-button x-show="!edit" class="ml-2" wire:click="save"
                            wire:loading.attr="disabled">
                            Guardar
                        </x-jet-button>
                        <x-jet-button x-show="edit" x-on:click="$wire.update(id)" class="ml-2"
                            wire:loading.attr="disabled"> Editar </x-jet-button>
